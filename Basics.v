...
Definition ltb (n m : nat) : bool :=
  if negb (eqb n m) then leb n m else false.
...
Proof.
  ...
  - destruct c eqn:Ec.
      + reflexivity.
      + simpl. intros Eabsurd. rewrite Eabsurd. reflexivity.
  - destruct c eqn:Ec.
      + simpl. intro Eabsurd. rewrite <- Eabsurd. reflexivity.
      + simpl. intro Eabsurd. rewrite Eabsurd. reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  - destruct c.
   + reflexivity.
   + simpl. intro Fabsurd. rewrite Fabsurd. reflexivity.
  - destruct c.
   + simpl. intro Fabsurd. rewrite Fabsurd. reflexivity.
   + simpl. reflexivity.
Qed.
